...
def util_delete_user_v0(
    ...
    try:
        ...
        return value
        """
        modified_response = DeleteUserV0Response(**response.model_dump())
        return JSONResponse(
...
@global_object_square_logger.auto_logger()
def util_get_user_profile_photo_v0(
    access_token: Annotated[str, Header()],
):
...
@global_object_square_logger.auto_logger()
def util_update_profile_photo_v0(
    access_token: Annotated[str, Header()],
...
@global_object_square_logger.auto_logger()
def util_validate_email_verification_code_v0(
    access_token: Annotated[str, Header()],
    ...
    try:
        ...
        return value
        """
        modified_response = StandardResponse[ValidateEmailVerificationCodeV0Response](
            **response.model_dump()
        )
        return JSONResponse(
            status_code=status.HTTP_200_OK,
...
def util_send_reset_password_email_v0(
    ...
    try:
        ...
        return value
        """
        modified_response = StandardResponse[SendResetPasswordEmailV0Response](
            **response.model_dump()
        )
        return JSONResponse(
            status_code=status.HTTP_200_OK,
...
@global_object_square_logger.auto_logger()
def util_generate_account_backup_codes_v0(
    access_token: Annotated[str, Header()],
):
    ...
    try:
        ...
        return value
        """
        modified_response = StandardResponse[GenerateAccountBackupCodesV0Response](
            **response.model_dump()
        )
        return JSONResponse(
            status_code=status.HTTP_200_OK,
...
def util_update_user_recovery_methods_v0(
    ...
    try:
        ...
        return value
        """
        modified_response = StandardResponse[UpdateUserRecoveryMethodsV0Response](
            **response.model_dump()
        )
        return JSONResponse(
            status_code=status.HTTP_200_OK,
